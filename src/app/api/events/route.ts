 ...
 * All dates are stored in UTC in memory
 *
 * NOTE: This uses in-memory storage for production compatibility.
 * Events will be lost when the server restarts.
 */
...
/**
 * Read events from in-memory storage
 */
...
/**
 * Write events to in-memory storage
 */
